...
//    unsigned long borderCount = [fileList count] + 1;
    ...
    for (int i = 0; i < filterCount; i++)
    {
        ...
        {
            NSString *name = [NSString stringWithFormat:@"filter_%i.JPG", i];
            NSString *path = [[NSBundle mainBundle] pathForResource:name ofType:nil];
            UIImage *img = [[UIImage alloc] initWithContentsOfFile:path];
            [button setImage:img forState:UIControlStateNormal];
        }
    ...
    [_storyboardView setContentSize:CGSizeMake(filterCount*width, height)];
}
...
//    unsigned long borderCount = [fileList count];
    ...
    for (int i = 0; i < stickerCount; i++)
    {
        ...
        NSString *name = [NSString stringWithFormat:@"sticker_%i.png", i+1];
        NSString *path = [[NSBundle mainBundle] pathForResource:name ofType:nil];
        UIImage *img = [[UIImage alloc] initWithContentsOfFile:path];
        [button setImage:img forState:UIControlStateNormal];
    ...
    [_storyboardView setContentSize:CGSizeMake(stickerCount*width, height)];
}
...
//    unsigned long borderCount = [fileList count];
    ...
    for (int i = 0; i < faceCount; i++)
    {
        ...
        NSString *name = [NSString stringWithFormat:@"face_%i.png", i+1];
        NSString *path = [[NSBundle mainBundle] pathForResource:name ofType:nil];
        UIImage *img = [[UIImage alloc] initWithContentsOfFile:path];
        [button setImage:img forState:UIControlStateNormal];
    ...
    [_storyboardView setContentSize:CGSizeMake(faceCount*width, height)];
}
...
- (void)initResourceFormBlurBackground
{
    ...
    [_storyboardView setContentSize:CGSizeMake(blurCount*width, height)];
}
